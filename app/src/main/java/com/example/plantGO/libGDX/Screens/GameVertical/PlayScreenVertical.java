package com.example.plantGO.libGDX.Screens.GameVertical;
...
import com.example.plantGO.libGDX.Tools.GameVertical.B2WorldCreatorVertical;
import com.example.plantGO.libGDX.Tools.GameVertical.WorldContactListenerVertical;
import com.example.plantGO.libGDX.Scenes.GameVertical.GameControllerVertical;
...
public class PlayScreenVertical implements Screen{
    ...
    public void handleInput(float dt) {
        ...
        if(Modele.compteurDechetCollecte < 1) {
            ...
            GameVertical.manager.get("audio/sounds/win.wav", Sound.class).play();
