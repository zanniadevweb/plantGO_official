package com.example.plantGO.libGDX.Scenes.GameVertical;
...
public class GameControllerVertical {
    ...
    public GameControllerVertical(){
        ...
        table.add().width(350f); // Ajoute un espace à droite de la touche haut afin de compenser l'espace ajouté à gauche de la touche droite
