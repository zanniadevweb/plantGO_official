package com.example.plantGO.Tools.GameVertical;
...
import com.example.plantGO.Sprites.TileObjects.InteractiveTileObject;
...
public class WorldContactListenerVertical implements ContactListener {
    ...
    public void beginContact(Contact contact) {
        ...
        switch (cDef){
            case GameVertical.ENNEMY_HEAD_BIT | GameVertical.MARIO_BIT:
            ...
            case GameVertical.ENNEMY_BIT | GameVertical.BLOQUEURENNEMITERRESTRE_BIT:
                ...
                break;
            case GameVertical.MARIO_BIT | GameVertical.ENNEMY_BIT:
                if(fixA.getFilterData().categoryBits == GameVertical.MARIO_BIT)
