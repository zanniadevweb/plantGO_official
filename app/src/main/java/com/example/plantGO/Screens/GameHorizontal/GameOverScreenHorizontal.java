...
public class GameOverScreenHorizontal implements Screen {
    private Viewport viewport;
    private Stage stage;
    private Game game;

    public GameOverScreenHorizontal(Game game){
        this.game = game;
    ...
    public void render(float delta) {
        if(Gdx.input.justTouched()) {
            game.setScreen(new PlayScreenHorizontal((GameHorizontal) game));
            dispose();
        }
